...
operadorAsignar				: NOMBRE_VARIABLE IGUAL VALOR_DATO PUNTO_COMA;
operadorSuma				: NOMBRE_VARIABLE OPERADOR_SUMA VALOR_DATO PUNTO_COMA;
operadorResta				: NOMBRE_VARIABLE OPERADOR_RESTA VALOR_DATO PUNTO_COMA;
operadorMultiplicacion		: NOMBRE_VARIABLE OPERADOR_MULT VALOR_DATO PUNTO_COMA;
operadorDivision			: NOMBRE_VARIABLE OPERADOR_DIV VALOR_DATO PUNTO_COMA;
